...
namespace Team17Project.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            ViewBag.ImgId = new SelectList(db.Images, "Id", "Url");
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,ImgId,Text")] Comment comment)
        {
            ...
            ViewBag.ImgId = new SelectList(db.Images, "Id", "Url", comment.ImgId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,ImgId,Text")] Comment comment)
        {
            if (ModelState.IsValid)
            {
